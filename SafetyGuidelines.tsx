        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-3 text-gray-700 font-semibold">
              ...
              <li className="flex items-start gap-3">
                <span className="text-[#10B981] font-black mt-1">✓</span>
                <span><strong>Keep Support Contacts Handy:</strong> For any assistance, reach out to our 24/7 support via email: <a href="mailto:contact@asiabylocals.com" className="text-[#10B981] hover:underline">contact@asiabylocals.com</a></span>
              </li>
            </ul>
          </section>
