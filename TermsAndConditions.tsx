      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-10">
            ...
            <ul className="space-y-2 text-gray-700 font-semibold">
              <li>• Contact us first through our 24/7 support email (<a href="mailto:contact@asiabylocals.com" className="text-[#10B981] hover:underline">contact@asiabylocals.com</a>)</li>
