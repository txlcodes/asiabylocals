  ...
  return (
    <div className="bg-white min-h-screen relative font-['Plus_Jakarta_Sans']">
      ...
      <section className="mb-16">
        <div className="bg-gray-50 rounded-xl p-6 border-2 border-gray-200 mx-8">
          <h2 className="text-xl font-black text-[#001A33] mb-6 text-center">Contact Us</h2>
          <div className="text-center mb-6">
            <p className="text-[#001A33] font-black text-lg">AsiaByLocals Singapore Pte. Ltd.</p>
            <p className="text-gray-500 font-bold text-sm mt-1">UEN: 202425442W</p>
          </div>
          <div className="space-y-4">
            <div className="text-center">
              ...
              <p className="text-gray-600 font-semibold mt-3">
                Email: <a href="mailto:info@asiabylocals.com" className="text-[#10B981] hover:underline">info@asiabylocals.com</a>, <a href="mailto:contact@asiabylocals.com" className="text-[#10B981] hover:underline">contact@asiabylocals.com</a>
              </p>
            </div>
          </div>
        </div>
